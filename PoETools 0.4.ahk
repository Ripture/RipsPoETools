...
Menu, ItemTooltipOptions, Add, Set Defaults, SetDefaults
...
SetDefaults:
{
 replaceItemized := "ItemTTShowItemized := "				;build the search string to replace default for show itemized
 replaceItemized .= ItemTTShowItemized ? "false" : "true"
 replaceItemizedWith := "ItemTTShowItemized := "			;build the string to replace with (true to false, false to true)
 replaceItemizedWith .= ItemTTShowItemized ? "true" : "false"
 
 replaceAttackSpd := "ItemTTShowAttackSpd := "				;build the search string to replace default for show attack speed
 replaceAttackSpd .= ItemTTShowAttackSpd ? "false" : "true"
 replaceAttackSpdWith := "ItemTTShowAttackSpd := "			;build the string to replace with (true to false, false to true)
 replaceAttackSpdWith .= ItemTTShowAttackSpd ? "true" : "false"
 
 replaceILevel := "ItemTTShowILevel := "					;build the search string to replace default for show item level
 replaceILevel .= ItemTTShowILevel ? "false" : "true"
 replaceILevelWith := "ItemTTShowILevel := "				;build the string to replace with (true to false, false to true)
 replaceILevelWith .= ItemTTShowILevel ? "true" : "false"
 
 FileRead, File, %A_ScriptFullPath%
 StringReplace, File, File, %replaceItemized%, %replaceItemizedWith%
 StringReplace, File, File, %replaceAttackSpd%, %replaceAttackSpdWith%
 StringReplace, File, File, %replaceILevel%, %replaceILevelWith%
 FileDelete, %A_ScriptFullPath%
 FileAppend, %File%, %A_ScriptName%
 
 MsgBox Defaults have been set.
 return
}
